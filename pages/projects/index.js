...
function projectsPage() {
    return(
        <div>
            ...
            <div className="flex flex-wrap overflow-hidden py-10 px-6 md:py-[2%] md:px-[15%]">
                <div className="md:w-1/3 overflow-hidden">
                    ...
                    <span className="text-xs font-semibold inline-block py-1 px-2 uppercase rounded-full text-salmondark bg-salmon last:mr-0 mr-1">NextJS</span>
                    <span className="text-xs font-semibold inline-block py-1 px-2 uppercase rounded-full text-salmondark bg-salmon last:mr-0 mr-1">TailwindCSS</span>
                    <br/>
                    <br/>
                ...
                <div className="md:w-2/3 overflow-hidden md:pl-8">
            ...
            <div className="flex flex-wrap overflow-hidden py-10 px-6 md:py-[2%] md:px-[15%]">
                <div className="md:w-1/3 overflow-hidden">
                    ...
                    <span className="text-xs font-semibold inline-block py-1 px-2 uppercase rounded-full text-salmondark bg-salmon last:mr-0 mr-1">NextJS</span>
                    <span className="text-xs font-semibold inline-block py-1 px-2 uppercase rounded-full text-salmondark bg-salmon last:mr-0 mr-1">NextAuth</span>
                    <span className="text-xs font-semibold inline-block py-1 px-2 uppercase rounded-full text-salmondark bg-salmon last:mr-0 mr-1">TailwindCSS</span>
                    <br/>
                    <br/>
